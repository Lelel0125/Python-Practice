...
class WeatherApp(QWidget):
    ...
    def initUI(self):
        ...
        self.temparature_label.setObjectName("temperature_label")
    ...
    def get_weather(self):
        ...
        # you can get your Api_key on the openweathermap website.
        api_key = ""
    ...
    def display_weather(self, data):
        ...
        temperature_f = (temparature_k * 9 / 5) - 459.67
        weather_id = data["weather"][0]["id"]
        weather_description = data["weather"][0]["description"]

        self.temparature_label.setText(f"{temparature_c:.0f}℃")
        self.emoji_label.setText(f"{self.get_weather_emoji(weather_id)}")
